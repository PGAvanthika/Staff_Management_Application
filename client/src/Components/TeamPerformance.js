...
import "./TeamPerformance.css"; // Make sure this file is created
// Replace this with your actual image import
// import userImg from "../assets/your-image.jpg";
    ...
    <div className="container-fluid vh-100 d-flex p-0">
      ...
      <div className="main-content flex-grow-1 bg-custom p-4 overflow-auto">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h2 className="fw-bold m-0">{selectedProject}</h2>
        ...
        <div className="row g-4">
          {projectData[selectedProject].map((staff, idx) => (
            <div key={idx} className="col-6 col-md-4 col-lg-3">
              <div className="card text-center p-3 staff-card shadow-sm">
                {staff.image ? (
                  <img
                    src={staff.image}
                    alt={staff.name}
